...
var IMakiswapPair = _interopDefault(require('makiswap-core/build/IMakiswapPair.json'));
...
})(exports.Rounding || (exports.Rounding = {})); // testnet export const FACTORY_ADDRESS = '0x40776e5b51767362285DCD7b011Dd8D66d4ca58f'
...
var WPLS = (_WPLS = {}, _WPLS[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0xcF1Fc503CA35618E9b4C08b7847980b3e10FB53B', 18, 'WPLS', 'Wrapped Pulse'), _WPLS[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xA1077a294dDE1B09bB078844df40758a5D0f9a27', 18, 'WPLS', 'Wrapped Pulse'), _WPLS);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === PLS && pairs[0].involvesToken(WPLS[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === PLS && pairs[pairs.length - 1].involvesToken(WPLS[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === PLS ? CurrencyAmount.pls(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === PLS ? CurrencyAmount.pls(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(plsIn && plsOut) ?  invariant(false, 'PLS_IN_OUT')  : void 0;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IMakiswapPair.abi, provider).getReserves()).then(function (_ref) {
...
//# sourceMappingURL=maki-pulsechain-sdk.cjs.development.js.map
