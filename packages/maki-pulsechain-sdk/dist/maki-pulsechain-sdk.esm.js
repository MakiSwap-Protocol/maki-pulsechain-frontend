...
})(Rounding || (Rounding = {})); // testnet export const FACTORY_ADDRESS = '0x40776e5b51767362285DCD7b011Dd8D66d4ca58f'


var FACTORY_ADDRESS = '0xBe85A2323cc554D26047172CC1F8AF7c715415b6';
var INIT_CODE_HASH = '0x67447ba49f302305b81cef8fb4391fd200d30178c1a4e1778a21316c72534cf0'; // UPDATE
...
Currency.PLS = /*#__PURE__*/new Currency(18, 'PLS', 'PLS');
var PLS = Currency.PLS;
...
var WPLS = (_WPLS = {}, _WPLS[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0xcF1Fc503CA35618E9b4C08b7847980b3e10FB53B', 18, 'WPLS', 'Wrapped Pulse'), _WPLS[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xA1077a294dDE1B09bB078844df40758a5D0f9a27', 18, 'WPLS', 'Wrapped Pulse'), _WPLS);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  /**
   * Helper that calls the constructor with the PLS currency
   * @param amount pls amount in wei
   */


  CurrencyAmount.pls = function pls(amount) {
    return new CurrencyAmount(PLS, amount);
  };
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount.pls(_Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'MAKI-LP', 'Makiswap LP');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === PLS && pairs[0].involvesToken(WPLS[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === PLS && pairs[pairs.length - 1].involvesToken(WPLS[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WPLS[pairs[0].chainId]];
 ...
 * In other words, if the currency is PLS, returns the WPLS token amount for the given chain. Otherwise, returns
 * the input currency amount.
 */

function wrappedAmount(currencyAmount, chainId) {
  if (currencyAmount instanceof TokenAmount) return currencyAmount;
  if (currencyAmount.currency === PLS) return new TokenAmount(WPLS[chainId], currencyAmount.raw);
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === PLS) return WPLS[chainId];
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === PLS ? CurrencyAmount.pls(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === PLS ? CurrencyAmount.pls(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount.pls(slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount.pls(slippageAdjustedAmountIn);
    }
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var plsIn = trade.inputAmount.currency === PLS;
    var plsOut = trade.outputAmount.currency === PLS; // the router does not support both ether in and out

    !!(plsIn && plsOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'PLS_IN_OUT') : invariant(false) : void 0;
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[ChainId.MAINNET] = {
  /* ADD TOKENS HERE */
  '0x10cf8b3d748a38f6f2063e8a30f44c9d674e4fe2': 18,
  '0xdf08630d0ae0110754ca04694d2645c0f170e54b': 18,
  '0xa1077a294dde1b09bb078844df40758a5d0f9a27': 18,
  '0x0cb6f5a34ad42ec934882a05265a7d5f59b51a2f': 6,
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IMakiswapPair.abi, provider).getReserves()).then(function (_ref) {
...
export { ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, PLS, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WPLS, currencyEquals, inputOutputComparator, tradeComparator };
//# sourceMappingURL=maki-pulsechain-sdk.esm.js.map
